# Endpoint Review — `DELETE /groups/{groupSlug}`
...
/private/tmp/0a910a92-3ef9-4ad2-9e1d-da4a9d385c74/test-mastra-api-forge-dotnet/ApiForge.Tests/Application/Groups/GroupServiceTests.cs(26,20): error CS7036: There is no argument given that corresponds to the required parameter 'logger' of 'GroupService.GroupService(IGroupRepository, IValidator<CreateGroupRequest>, IValidator<UpdateGroupRequest>, ILogger<GroupService>)' [/private/tmp/0a910a92-3ef9-4ad2-9e1d-da4a9d385c74/test-mastra-api-forge-dotnet/ApiForge.Tests/ApiForge.Tests.csproj]
...
/private/tmp/0a910a92-3ef9-4ad2-9e1d-da4a9d385c74/test-mastra-api-forge-dotnet/ApiForge.Tests/Application/Groups/GroupServiceTests.cs(59,38): err
```
